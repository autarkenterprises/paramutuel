...
/// @notice Deploy `ParamutuelFactoryV2` (ADR-0008 bitmask / policy wagers).
/// Run with:
...
contract DeployFactoryV2 is Script {
    function run() external {
        ...
        ParamutuelFactoryV2 factory = new ParamutuelFactoryV2(
            treasury, protocolFeeBps, minBettingWindow, minResolutionWindow
        );
        vm.stopBroadcast();

        console.log("ParamutuelFactoryV2 deployed at:", address(factory));
